    ...
    while($row_p_cats=mysqli_fetch_array($run_p_cats)){
        ...
        echo "
            ...
            <li>
                ...
                <a href='result.php?p_cat=$p_cat_id'/> $p_cat_title </a>
...
function getpcatprosearch(){
    ...
    if(isset($_GET['p_cat'])){
        ...
        $get_products ="select * from products where p_cat_id='$p_cat_id'and like'%search%' ";
