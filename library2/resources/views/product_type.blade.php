...
<body>
	...
	<div class="container" id= "slide" style= "margin-bottom: 30px">
		<div class= "col-md-12">
			<div class= "carousel slide col-md-6 col-md-offset-3" id= "myCarousel" data-ride= "carousel">
				...
				<div class= "carousel-inner"> <!-- carousel-inner Begin -->
					<div class= "item active">
						<img src= "/ShoesImage/slide/slide1.jpg" alt= "picture1.">
					</div>
					<div class= "item">
						<image src= "/ShoesImage/slide/slide2.jpg" alt= "picture2.">
					</div>
					<div class= "item">
						<image src= "/ShoesImage/slide/slide3.jpg" alt="picture3.">
					</div>
					<div class= "item">
						<image src= "/ShoesImage/slide/slide4.jpg" alt="picture4">
					</div>
					<div class= "item">
						<image src= "/ShoesImage/slide/slide5.jpg" alt="picture5">
					</div>
	...
	<div class="container">
		...
		<!-- ITEM SRART -->
		<div class="row">
			@foreach($product_type as $prdt)
			<div class="col-xs-12 col-sm-6 col-md-3">
				<div class="img-thumbnail">
					<img src="/ShoesImage/{{$prdt->image}}" class="img-responsive">
				</div>
				<div class="caption">
					<div>
						<h4>{{$prdt->name}}</h4>
					...
					<div class="row">
						<div class="col-md-4 col-sm-4 col-xs-4 price" >
							<h3 style="margin: 5px auto;"><label>${{$prdt->price}}</label></3>
						</div>
