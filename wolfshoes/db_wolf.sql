...
--
-- Host: localhost
-- Generation Time: May 02, 2019 at 07:37 AM
...
(1, 'Vans Old Skool', 1, 'vn-0d3hy28_vn-0d3hy28_blk_01_20290.jpg', 'van3.jpg', '/Applications/XAMPP/xamppfiles/temp/phpZfCzLb', 1485000, 'Thiết kế Vans Old Skool Classic trắng đen kinh điển, sử dụng kết hợp chất liệu vải Canvas mềm, nhẹ ở thân giày và chất liệu da lộn ở mũi giày và đế giày mang đến cho bạn sự thoải mái khi di chuyển. Đế cao su chuyên dùng cho bộ môn trượt ván đảm bảo độ bền chắc và có độ bám tốt. Khả năng kết hợp nhiều outfit mà không sợ bị lệch tông.', 1, '2019-04-29 10:03:35', '2019-04-29 17:34:55'),
(2, 'Vans ERA Get The Real #95', 1, 'VN0A38FRTO3-DRAKE-500x500.jpg', 'VN0A38FRTO3-DRAKE2-650x650.jpg', 'VN0A38FRTO3-DRAKE4-650x650.jpg', 1305000, 'Giữ nguyên kiểu dáng của dòng Vans Era với lót đệm cổ chân êm ái để di chuyển linh hoạt. Điểm nhấn ở sản phẩm là tên dòng giày GET THE REAL #95 được đặt ở bên hông đế giày tạo sự khác biệt. Đồng thời lưỡi gà màu đen nằm dưới phần Upper đỏ khiến đôi giày càng trở nên bắt mắt và đặc biệt.', 1, '2019-04-29 10:06:05', '2019-04-29 17:36:12'),
(3, 'Vans UA Old Skool I Heart Vans', 1, 'VN0A38G1VR9-DRAKE3-1-650x650.jpg', 'VN0A38G1VR9-DRAKE4-650x650.jpg', 'VN0A38G1VR9-DRAKE3-1-650x650.jpg', 1575000, 'Kiểu dáng Old Skool quen thuộc kết hợp thiết kế trẻ trung, năng động cùng họa tiết I HEART MY VANS lạ mắt nổi lên 2 bên thân giày, mang đến sự đặc biệt cho sản phẩm. Ngoài ra, đường viền xung quanh đế giày được thay bằng màu xanh đồng bộ với họa tiết chữ.', 1, '2019-04-29 10:08:11', '2019-04-29 17:37:24'),
...
(7, 'Chuck Taylor All Star Leather', 3, '131274-650x650.jpg', 'IMG_4659-650x650', 'IMG_4661-650x650.jpg', 1350000, 'Với thiết kế cổ điển được ưa chuộng của dòng Classic đi kèm với chất liệu da mềm nhẹ, có độ bóng, phần để cao su bền chắc cùng đường viền đen đặc trưng. Phiên bản màu đen bằng da của Converse Classic cổ thấp chắc chắn là item đơn giản phù hợp với mọi phong cách đáng để bạn sở hữu.', 1, '2019-04-29 10:15:55', '2019-04-29 17:40:16'),
...
(1, 'DangLiem', 'dangliem.uet@gmail.com', 1, NULL, '$2y$10$IHmx04VJ5Pj5YGXEMCE17.tr/irRTlOvyfxZc.I7VPgnd.bGeKIra', NULL, '2019-04-23 12:06:47', '2019-04-29 02:05:35');
